...
<div class="col s12 m12 l12">
    <div class="card-panel">
        ...
        <ul class="tabs tabs-months z-depth-1">
            <?php foreach ($result['data'] as $month => $data): ?>
                <li class="tab col s3"><a class="active"
                                          href="#month-<?php echo $month; ?>"><?php echo D::getMonthName($month); ?></a>
                </li>
            <?php endforeach; ?>
        </ul>

        <div class="col s12" style="margin-top: 20px;">
            <?php foreach ($result['data'] as $month => $items): ?>
                <div id="month-<?php echo $month; ?>" class="col s12">
