...
<div class="card-panel" style="margin-top: 25px; float: left; width: 100%;">
    <div class="row">
        ...
        <ul id="task-card" class="collection with-header">
            ...
            ?>
            <?php foreach (ActivityExtendedStatisticFields::find()->where([ 'parent_id' => $section->id ])->andWhere([ '!=', 'value_type', ActivityExtendedStatisticFields::CALC ])->all() as $field_item): ?>
